...
<form method="post">
    <div class="carroussel-image">
        <div class="carroussel-image-relative">
            <button type="submit" name="Hotels" title="Afficher les hôtels">
                <img class="image-accueil" src="images/hotel.png" alt="images hotels" />
            </button>
        ...
        <div class="carroussel-image-relative">
            <button type="submit" name="Restaurants" title="Afficher les restaurants">
        ...
        <div class="carroussel-image-relative">
            <button type="submit" name="Loisirs" title="Afficher les loisirs">
